  ...
  return (
    <Layout>
      <div className="top mb-5 px-5 mt-5">
        <div className=" bg-red-400 py-5 border border-black rounded-lg">
      ...
      <div className="px-5">
        <div className="mid mb-5">
          <div className=" bg-red-400 py-5 rounded-xl border border-black">
          ...
          <Tabs>
            <TabList className="flex flex-wrap -m-4 text-center justify-center">
              <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                <div className=" border bg-red-400 hover:bg-red-300 border-black px-4 py-3 rounded-xl">
                  <div className=" w-12 h-12 mb-3 text-white inline-block">
                    <svg
                  ...
                  <p className=" text-white  font-bold">Total Dishes</p>
                </div>
              </Tab>
